...
$string['settings:aws:usepathstyle_help'] = 'Enable path-style endpoint access. This is required for some S3-compatible storage providers like MinIO. When enabled, URLs will be formatted as http://s3.amazonaws.com/bucket/key instead of http://bucket.s3.amazonaws.com/key.';
